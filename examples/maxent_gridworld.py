...
def main(grid_size, discount, n_trajectories, epochs, learning_rate):
    ...
    r1 = maxent.irl(feature_matrix, gw.n_actions, discount,
    ...
    feature_matrix = gw.feature_matrix()
    r2 = maxent.irl(feature_matrix, gw.n_actions, discount,
    ...
    for trajectory in new_sl_trajectories:
        for i in new_trajectories:
            if trajectory[-1] == i[-1]:
                ...
                break
    feature_matrix = gw.feature_matrix()
    r3 = maxent.irl(feature_matrix, gw.n_actions, discount,
...
if __name__ == '__main__':
    main(20, 0.9, 6, 200, 0.01) #(grid_size, discount, n_trajectories, epochs, learning_rate)
